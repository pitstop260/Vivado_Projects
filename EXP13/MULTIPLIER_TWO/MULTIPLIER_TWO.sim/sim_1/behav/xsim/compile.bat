...
REM
REM Generated by Vivado on Mon Sep 22 22:29:45 +0530 2025
...
echo "xvhdl --incr --relax -prj MULTIPLIER_TWO_vhdl.prj"
call xvhdl  --incr --relax -prj MULTIPLIER_TWO_vhdl.prj -log xvhdl.log
