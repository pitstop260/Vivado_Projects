...
REM
REM Generated by Vivado on Tue Oct 07 13:08:53 +0530 2025
...
echo "xvhdl --incr --relax -prj FA_PROC_vhdl.prj"
call xvhdl  --incr --relax -prj FA_PROC_vhdl.prj -log xvhdl.log
