...
REM
REM Generated by Vivado on Fri Aug 22 14:08:17 +0530 2025
...
echo "xvhdl --incr --relax -prj FA_CASE_vhdl.prj"
call xvhdl  --incr --relax -prj FA_CASE_vhdl.prj -log xvhdl.log
