...
REM
REM Generated by Vivado on Fri Aug 22 22:01:22 +0530 2025
...
echo "xvhdl --incr --relax -prj PRIORITY_ENCODER_4X2_vhdl.prj"
call xvhdl  --incr --relax -prj PRIORITY_ENCODER_4X2_vhdl.prj -log xvhdl.log
