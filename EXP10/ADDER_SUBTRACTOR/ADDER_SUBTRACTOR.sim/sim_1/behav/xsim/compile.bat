...
REM
REM Generated by Vivado on Sat Aug 30 10:28:12 +0530 2025
...
echo "xvhdl --incr --relax -prj ADDER_SUBTRACTOR_vhdl.prj"
call xvhdl  --incr --relax -prj ADDER_SUBTRACTOR_vhdl.prj -log xvhdl.log
