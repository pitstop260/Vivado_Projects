...
REM
REM Generated by Vivado on Tue Sep 23 20:38:06 +0530 2025
...
echo "xvhdl --incr --relax -prj BCD_ADDER_vhdl.prj"
call xvhdl  --incr --relax -prj BCD_ADDER_vhdl.prj -log xvhdl.log
