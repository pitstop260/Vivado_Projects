...
REM
REM Generated by Vivado on Tue Aug 12 10:05:16 +0530 2025
...
echo "xvhdl --incr --relax -prj OR_GATE_vhdl.prj"
call xvhdl  --incr --relax -prj OR_GATE_vhdl.prj -log xvhdl.log
