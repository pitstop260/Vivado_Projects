...
REM
REM Generated by Vivado on Tue Aug 12 11:01:31 +0530 2025
...
echo "xvhdl --incr --relax -prj NOR_GATE_vhdl.prj"
call xvhdl  --incr --relax -prj NOR_GATE_vhdl.prj -log xvhdl.log
