...
REM
REM Generated by Vivado on Mon Sep 22 23:51:04 +0530 2025
...
echo "xvhdl --incr --relax -prj DFF_RE_vhdl.prj"
call xvhdl  --incr --relax -prj DFF_RE_vhdl.prj -log xvhdl.log
