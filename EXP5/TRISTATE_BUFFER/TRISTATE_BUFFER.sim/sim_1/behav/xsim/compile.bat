...
REM
REM Generated by Vivado on Sun Aug 17 20:48:03 +0530 2025
...
echo "xvhdl --incr --relax -prj TRISTATE_BUFFER_vhdl.prj"
call xvhdl  --incr --relax -prj TRISTATE_BUFFER_vhdl.prj -log xvhdl.log
