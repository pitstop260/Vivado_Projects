...
REM
REM Generated by Vivado on Sat Aug 30 09:06:01 +0530 2025
...
echo "xvhdl --incr --relax -prj PARALLEL_ADDER_vhdl.prj"
call xvhdl  --incr --relax -prj PARALLEL_ADDER_vhdl.prj -log xvhdl.log
